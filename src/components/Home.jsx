...
export default function Home() {
    ...
    const habdlePersonShow = () => setPersonShow(true);
        ...
        <div>
            ...
            <Container className='centered mt-5'>
                ...
                <div className='mt-2 bottomText' style={{ marginBottom: "15px" }}>
                    ...
                    <br />
                    Business Lincense 000-00-00000 Tel 000-0000-0000 Fax 00-000-0000
                </div>
                <div className='bottomText'>
                    <span className='p-3' onClick={handleUseShow}>
                        이용약관
                    </span>
                    <span onClick={habdlePersonShow}>개인정보처리방침</span>
                </div>
            </Container>
            <Modal show={personShow} onHide={handlePersonClose}>
                ...
                <Modal.Body style={{ fontSize: "0.8em" }}>
                    ...
                    <p class='section-title'>제1조 (개인정보의 처리목적)</p>
                    <p>
                    ...
                    <p class='section-title'>제2조 (개인정보의 처리 및 보유기간)</p>
                    <p>
                    ...
                    <p class='section-title'>제3조 (개인정보의 제3자 제공)</p>
                    <p>
                    ...
                    <p class='section-title'>제4조(개인정보처리의 위탁)</p>
